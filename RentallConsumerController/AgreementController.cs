...
namespace RentallConsumerController
{
    public class AgreementController
    {
        ...
        public AddChecklistMobileResponse saveCheckListMobile(AddChecklistMobileRequest request, string token)
        {
            AddChecklistMobileResponse response = null;
            try
            {
                response = agreementService.saveCheckListMobile(request, token);
            }
            catch (Exception ex)
            {
                throw ex;
