        ...
        private async void SaveBtn_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (returnListAfterEdited != null)
                {
                    ...
                    addChecklistMobileRequest.DefaultDamageChecklistout = returnListAfterEdited;
                    addChecklistMobileRequest.DefaultDamageChecklistIn = checklistMobileResponse.DefaultDamageChecklistIn;
