...
namespace RentallConsumer.Views
{
    public partial class AddPersonalInformationPage : ContentPage
    {
        ...
        private void navigateNextPage()
        {
            ...
            try
            {
                var birthDate = ((DateTime)DateOfBithEntry.Date).ToString("MM/dd/yyyy hh:mm tt", CultureInfo.InvariantCulture);
                var cbirthDate = DateTime.ParseExact(birthDate, "MM/dd/yyyy hh:mm tt", CultureInfo.InvariantCulture);
                customer.DateOfbirth = cbirthDate;
            }
            catch (Exception ex)
            {
        ...
        void CountryEntry_Focused(System.Object sender, Xamarin.Forms.FocusEventArgs e)
        {
        ...
        void StateEntry_Focused(System.Object sender, Xamarin.Forms.FocusEventArgs e)
        {
            StateEntry.Unfocus();
            Device.BeginInvokeOnMainThread(() => {
                statePicker.Focus();
        ...
        void statePicker_Unfocused(System.Object sender, Xamarin.Forms.FocusEventArgs e)
        {
